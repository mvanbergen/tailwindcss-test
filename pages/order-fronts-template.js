...
const OrderFrontsTemplate = () => {
  ...
  return (
    <>
    <Head>
                <title>Kitchen Cubes | Order Door, Drawer, Lazy Susan, Diagonal Wall Fronts</title>
                <meta name="keywords" content="cabinet fronts doors drawers sinks hardware" />
            </Head>
      ...
      <div className="relative flex min-h-screen flex-col">
        {/* Navbar */}
        {/* IF I REMOVE THE <DISCLOSURE ...... </DISCLOSURE> SECTION THE PAGE RENDERS FINE. */}
...
export default OrderFrontsTemplate;